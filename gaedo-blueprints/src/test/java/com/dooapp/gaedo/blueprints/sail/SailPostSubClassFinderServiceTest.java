...
public class SailPostSubClassFinderServiceTest extends AbstractSailGraphTest {
	...
	private static final Logger logger = Logger.getLogger(SailPostSubClassFinderServiceTest.class.getName());
	...
	public SailPostSubClassFinderServiceTest(GraphProvider graph) {
		super(graph);
	}
