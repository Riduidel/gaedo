...
public class Updater {
	...
	public void updateLiteralPropertyIn(Graph database, Object toUpdate, Vertex vertexToUpdate, Property property, Object propertyValue) {
		LiteralTransformer<Object> transformer = Literals.get(propertyValue.getClass());
		GraphUtils.setIndexedProperty(database, vertexToUpdate, GraphUtils.getEdgeNameFor(property), transformer.toString(propertyValue));
	}
}
